...
class StudiesControllerTest < ActionController::TestCase
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post :create, study: { completed: @study.completed, slug: @study.slug, title: @study.title, user_id: @study.user_id }
    end
  ...
  test "should update study" do
    patch :update, id: @study, study: { completed: @study.completed, slug: @study.slug, title: @study.title, user_id: @study.user_id }
    assert_redirected_to study_path(assigns(:study))
  end
